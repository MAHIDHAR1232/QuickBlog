...
const CommentTableItem = ({ comment, fetchComments }) => {
  ...
  const { blog, createdAt, isApproved, name, content } = comment;
      ...
      <td className='px-6 py-4'>
        <div className='inline-flex items-center gap-4'>
          {!comment.isApproved ? 
            ...
            /> :
            <p className='text-xs border border-green-600 bg-green-100 rounded-full px-3 py-1'>
              Approved
            </p>
          }
...
// const CommentTableItem = ({comment,fetComments}) => {
