    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <div className="max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative">
          {/* 👇 This is the missing editor container */}
          <div ref={editorRef} className="h-40 border rounded p-2"></div>
          {/* {loading && ( 
            <div className='absolute right-0 bottom-0 left-0 flex items-center justify-center mt-2'>
              <div className='w-8 h-8 rounded-full border-2 border-t-white animate-spin'></div>
            </div>
          )} */}
          {loading && (
            <div className="absolute inset-0 flex items-center justify-center bg-gray-200/60 backdrop-blur-sm rounded-lg">
              <div className="relative w-10 h-10">
                <div className="w-10 h-10 rounded-full border-4 border-transparent border-t-blue-600 animate-spin"></div>
                <div className="absolute inset-2 rounded-full border-2 border-dashed border-blue-400 animate-ping"></div>
              </div>
            </div>
          )}
